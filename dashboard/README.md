...
To make a change you'd contribute back: edit, test locally, open a PR against `VJ-yadav/localmem-community`. The dashboard is intentionally framework-free; please don't add React / Vue / Svelte unless we genuinely need them.
